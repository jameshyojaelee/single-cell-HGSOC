#!/bin/bash
#SBATCH --job-name=cr_SRR16093350
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093350.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093350.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093350"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093350_1.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093350_2.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093350/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093350"
    mv "SRR16093350/outs" "${OUTPUT_DIR}/SRR16093350/"
    rm -rf "SRR16093350"
fi
...
echo "Completed processing run: SRR16093350"
