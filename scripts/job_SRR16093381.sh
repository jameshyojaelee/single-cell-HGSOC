#!/bin/bash
#SBATCH --job-name=cr_SRR16093381
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093381.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093381.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093381"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093381_1.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093381_2.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093381/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093381"
    mv "SRR16093381/outs" "${OUTPUT_DIR}/SRR16093381/"
    rm -rf "SRR16093381"
fi
...
echo "Completed processing run: SRR16093381"
