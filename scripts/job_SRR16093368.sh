#!/bin/bash
#SBATCH --job-name=cr_SRR16093368
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093368.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093368.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093368"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093368_1.fastq" "${temp_fastq_dir}/GSM5599228_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093368_2.fastq" "${temp_fastq_dir}/GSM5599228_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093368/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093368"
    mv "SRR16093368/outs" "${OUTPUT_DIR}/SRR16093368/"
    rm -rf "SRR16093368"
fi
...
echo "Completed processing run: SRR16093368"
