#!/bin/bash
#SBATCH --job-name=cr_SRR16093374
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093374.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093374.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093374"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093374_1.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093374_2.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093374/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093374"
    mv "SRR16093374/outs" "${OUTPUT_DIR}/SRR16093374/"
    rm -rf "SRR16093374"
fi
...
echo "Completed processing run: SRR16093374"
