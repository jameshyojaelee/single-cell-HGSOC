#!/bin/bash
#SBATCH --job-name=cr_SRR16093337
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093337.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093337.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093337"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093337_1.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093337_2.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093337/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093337"
    mv "SRR16093337/outs" "${OUTPUT_DIR}/SRR16093337/"
    rm -rf "SRR16093337"
fi
...
echo "Completed processing run: SRR16093337"
