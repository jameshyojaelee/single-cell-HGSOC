# ======================================================================
# Differential Expression Analysis for Non-Immune Cells Across Stages
# ======================================================================
...
output_dir <- file.path(base_dir, "output/diff_expr/non_immune")
...
cat("\nDEG analysis complete for non-immune cells.\n")
