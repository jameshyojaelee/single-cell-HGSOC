#!/bin/bash
#SBATCH --job-name=cr_SRR16093361
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093361.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093361.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093361"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093361_1.fastq" "${temp_fastq_dir}/GSM5599227_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093361_2.fastq" "${temp_fastq_dir}/GSM5599227_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093361/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093361"
    mv "SRR16093361/outs" "${OUTPUT_DIR}/SRR16093361/"
    rm -rf "SRR16093361"
fi
...
echo "Completed processing run: SRR16093361"
