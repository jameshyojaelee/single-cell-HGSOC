# ======================================================================
# Differential Expression Analysis for Macrophages Across Stages
# ======================================================================
...
output_dir <- file.path(base_dir, "output/diff_expr/macrophages")
...
# This refers to the category after fine-tuning in script 4
...
# Subset the Seurat object to keep only the target macrophages
...
cat("\nDEG analysis complete for macrophages.\n")
