#!/bin/bash
#SBATCH --job-name=cr_SRR16093335
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093335.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093335.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093335"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093335_1.fastq" "${temp_fastq_dir}/GSM5599221_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093335_2.fastq" "${temp_fastq_dir}/GSM5599221_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093335/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093335"
    mv "SRR16093335/outs" "${OUTPUT_DIR}/SRR16093335/"
    rm -rf "SRR16093335"
fi
...
echo "Completed processing run: SRR16093335"
