# ============================================================
# Gene Ontology (GO) Enrichment Analysis of T Cell DEGs
# ============================================================
...
input_dir <- file.path(base_dir, "output/diff_expr/t_cells")
output_dir <- file.path(base_dir, "output/enrichment/GO_t_cells")
...
cat("\nGO enrichment analysis complete for T cells.\n")
cat(paste("Results saved in:", output_dir, "\n"))

# This script performs GO enrichment for all T cell subtypes (Naive CD4+ T cells, Memory CD4+ T cells, CD4+ NKT-like cells, CD8+ NKT-like cells)
# DEG files should be generated from all these subtypes combined. 