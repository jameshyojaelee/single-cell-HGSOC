#!/bin/bash
#SBATCH --job-name=cr_SRR16093375
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093375.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093375.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093375"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093375_1.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093375_2.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093375/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093375"
    mv "SRR16093375/outs" "${OUTPUT_DIR}/SRR16093375/"
    rm -rf "SRR16093375"
fi
...
echo "Completed processing run: SRR16093375"
