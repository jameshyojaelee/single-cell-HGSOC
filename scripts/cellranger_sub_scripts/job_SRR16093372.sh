#!/bin/bash
#SBATCH --job-name=cr_SRR16093372
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093372.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093372.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093372"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093372_1.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093372_2.fastq" "${temp_fastq_dir}/GSM5599229_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093372/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093372"
    mv "SRR16093372/outs" "${OUTPUT_DIR}/SRR16093372/"
    rm -rf "SRR16093372"
fi
...
echo "Completed processing run: SRR16093372"
