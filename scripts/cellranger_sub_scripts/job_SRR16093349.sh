#!/bin/bash
#SBATCH --job-name=cr_SRR16093349
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093349.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093349.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093349"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093349_1.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093349_2.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093349/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093349"
    mv "SRR16093349/outs" "${OUTPUT_DIR}/SRR16093349/"
    rm -rf "SRR16093349"
fi
...
echo "Completed processing run: SRR16093349"
