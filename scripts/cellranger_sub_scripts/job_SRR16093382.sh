#!/bin/bash
#SBATCH --job-name=cr_SRR16093382
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093382.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093382.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093382"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093382_1.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093382_2.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093382/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093382"
    mv "SRR16093382/outs" "${OUTPUT_DIR}/SRR16093382/"
    rm -rf "SRR16093382"
fi
...
echo "Completed processing run: SRR16093382"
