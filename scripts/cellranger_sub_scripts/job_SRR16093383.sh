#!/bin/bash
#SBATCH --job-name=cr_SRR16093383
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093383.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093383.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093383"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093383_1.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093383_2.fastq" "${temp_fastq_dir}/GSM5599230_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093383/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093383"
    mv "SRR16093383/outs" "${OUTPUT_DIR}/SRR16093383/"
    rm -rf "SRR16093383"
fi
...
echo "Completed processing run: SRR16093383"
