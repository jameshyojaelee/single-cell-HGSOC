#!/bin/bash
#SBATCH --job-name=cr_SRR16093355
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093355.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093355.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093355"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093355_1.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093355_2.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093355/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093355"
    mv "SRR16093355/outs" "${OUTPUT_DIR}/SRR16093355/"
    rm -rf "SRR16093355"
fi
...
echo "Completed processing run: SRR16093355"
