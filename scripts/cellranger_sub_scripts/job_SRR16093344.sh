#!/bin/bash
#SBATCH --job-name=cr_SRR16093344
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093344.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093344.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093344"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093344_1.fastq" "${temp_fastq_dir}/GSM5599223_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093344_2.fastq" "${temp_fastq_dir}/GSM5599223_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093344/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093344"
    mv "SRR16093344/outs" "${OUTPUT_DIR}/SRR16093344/"
    rm -rf "SRR16093344"
fi
...
echo "Completed processing run: SRR16093344"
