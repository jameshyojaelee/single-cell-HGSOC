#!/bin/bash
#SBATCH --job-name=cr_SRR16093339
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093339.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093339.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093339"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093339_1.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093339_2.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093339/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093339"
    mv "SRR16093339/outs" "${OUTPUT_DIR}/SRR16093339/"
    rm -rf "SRR16093339"
fi
...
echo "Completed processing run: SRR16093339"
