#!/bin/bash
#SBATCH --job-name=cr_SRR16093385
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093385.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093385.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093385"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093385_1.fastq" "${temp_fastq_dir}/GSM5599231_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093385_2.fastq" "${temp_fastq_dir}/GSM5599231_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093385/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093385"
    mv "SRR16093385/outs" "${OUTPUT_DIR}/SRR16093385/"
    rm -rf "SRR16093385"
fi
...
echo "Completed processing run: SRR16093385"
