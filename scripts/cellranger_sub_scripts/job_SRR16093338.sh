#!/bin/bash
#SBATCH --job-name=cr_SRR16093338
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093338.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093338.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093338"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093338_1.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093338_2.fastq" "${temp_fastq_dir}/GSM5599222_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093338/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093338"
    mv "SRR16093338/outs" "${OUTPUT_DIR}/SRR16093338/"
    rm -rf "SRR16093338"
fi
...
echo "Completed processing run: SRR16093338"
