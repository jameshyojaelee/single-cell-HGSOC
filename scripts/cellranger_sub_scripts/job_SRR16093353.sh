#!/bin/bash
#SBATCH --job-name=cr_SRR16093353
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093353.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093353.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093353"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093353_1.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093353_2.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093353/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093353"
    mv "SRR16093353/outs" "${OUTPUT_DIR}/SRR16093353/"
    rm -rf "SRR16093353"
fi
...
echo "Completed processing run: SRR16093353"
