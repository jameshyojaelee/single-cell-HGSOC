#!/bin/bash
#SBATCH --job-name=cr_SRR16093336
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093336.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093336.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093336"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093336_1.fastq" "${temp_fastq_dir}/GSM5599221_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093336_2.fastq" "${temp_fastq_dir}/GSM5599221_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093336/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093336"
    mv "SRR16093336/outs" "${OUTPUT_DIR}/SRR16093336/"
    rm -rf "SRR16093336"
fi
...
echo "Completed processing run: SRR16093336"
