#!/bin/bash
#SBATCH --job-name=cr_SRR16093329
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093329.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093329.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093329"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093329_1.fastq" "${temp_fastq_dir}/GSM5599220_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093329_2.fastq" "${temp_fastq_dir}/GSM5599220_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093329/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093329"
    mv "SRR16093329/outs" "${OUTPUT_DIR}/SRR16093329/"
    rm -rf "SRR16093329"
fi
...
echo "Completed processing run: SRR16093329"
