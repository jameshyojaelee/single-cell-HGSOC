#!/bin/bash
#SBATCH --job-name=cr_SRR16093354
#SBATCH --output=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093354.out
#SBATCH --error=/gpfs/commons/home/jameslee/HGSOC/output/logs/SRR16093354.err
...
temp_fastq_dir="${OUTPUT_DIR}/tmp_SRR16093354"
mkdir -p "${temp_fastq_dir}"

# Create symlinks with CellRanger expected naming convention
ln -sf "${FASTQ_DIR}/SRR16093354_1.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R1_001.fastq"
ln -sf "${FASTQ_DIR}/SRR16093354_2.fastq" "${temp_fastq_dir}/GSM5599225_S1_L001_R2_001.fastq"
...
if [ -d "SRR16093354/outs" ]; then
    mkdir -p "${OUTPUT_DIR}/SRR16093354"
    mv "SRR16093354/outs" "${OUTPUT_DIR}/SRR16093354/"
    rm -rf "SRR16093354"
fi
...
echo "Completed processing run: SRR16093354"
