# ============================================================
# Gene Ontology (GO) Enrichment Analysis of Macrophage DEGs
# ============================================================
...
input_dir <- file.path(base_dir, "output/diff_expr/macrophages")
output_dir <- file.path(base_dir, "output/enrichment/GO_macrophages")
...
cat("\nGO enrichment analysis complete for macrophages.\n")
